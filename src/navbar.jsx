...
//   return (
//     <div className="navp">
//       <h1 className="brand"><i>Nsh</i></h1>
//       <nav className="nav">
//         <ul>
//           <li><Link to="/home" id="home">Home</Link></li>
//           <li><Link to="/Trends" className="Trends">Trends</Link></li>
//           <Link to='/about' className="about"><li>About</li></Link>
          
//           <li><Link to="/Admin" className="Admin">Admin</Link></li>
//           <li><Link to="/Cart" className="Cart"><i className="fa-solid fa-cart-shopping"></i></Link></li>
//           <li>
//             <i
